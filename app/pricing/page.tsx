    ...
    plans: [
      {
        ...
        platform: "DXtrade",
        minTradingDays: "None",
        features: ["No time limit", "Free retry on profit", "Bi-weekly payouts", "Real market data"],
      ...
      },
      {
        ...
        platform: "DXtrade",
        minTradingDays: "None",
        features: ["No time limit", "Free retry on profit", "Bi-weekly payouts", "Priority support"],
    ...
    plans: [
      {
        ...
        platform: "DXtrade",
        minTradingDays: "None",
        features: ["Single phase", "No time limit", "Bi-weekly payouts", "Real market data"],
    ...
    plans: [
      {
        ...
        platform: "DXtrade",
        minTradingDays: "None",
        features: ["No evaluation", "Trade immediately", "Bi-weekly payouts", "Real market data"],
      ...
      },
      {
        ...
        platform: "DXtrade",
        minTradingDays: "None",
        features: ["No evaluation", "Trade immediately", "Weekly payouts", "Priority support"],
        isPopular: true,
