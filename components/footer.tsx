...
export function Footer() {
  return (
    <footer className="bg-[#09090B] border-t border-[#3F3F46]">
      <div className="container-wide">
        ...
        <div className="py-16 lg:py-20 grid grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="col-span-2">
            ...
            <div className="flex items-center gap-3">
              <a
                href="#"
                className="w-10 h-10 border border-[#3F3F46] flex items-center justify-center text-[#A1A1AA] hover:border-[#F97316] hover:text-[#F97316] transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-3">
              {links.platform.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-[#A1A1AA] hover:text-[#F97316] transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
        ...
        {/* Bottom Bar */}
        <div className="py-6 border-t border-[#3F3F46] flex flex-col lg:flex-row items-center justify-between gap-4 text-xs text-[#71717A]">
